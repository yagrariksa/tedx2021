...
@section('content')
    ...
    <div class="grid">
        ...
        <div class="card-left">
                ...
                <div class="mid">
                    ...
                    <div class="left">
                        <div class="list">
                            ...
                            <ol>
                                <li>
                                    The targeted participants of this competition are those who are currently 17-25 years
                                    old.
                                </li>
            ...
            <div class="cfe-btn">
                <a class="button"
                    href="https://drive.google.com/file/d/1Duvy0HibSGy-R8gDuTmpoS7epuneCrcO/view?usp=sharing" id="booklet"
                    style="height: 45px" target="_blank">Booklet</a>
                <a class="button btn-green" href="#" id="regist" style="height: 45px">Register</a>
            </div>
        </div>
    ...
    <script>
        ...
        regist.addEventListener('click',
            () => {
                ...
                if (d.getMonth() > 8) {
                    alert('Event Call for Essay sudah berakhir');
                } else if (d.getDate() > 16) {
                    alert('Event Call for Essay sudah berakhir');
                } else {
                    window.location = "{{ route('essay.form') }}"
                }
            })
    </script>
