      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{Request::is('admin/main*') ? 'active' : ''}}">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-file-alt"></i> <span>Main Event</span></a>
              <ul class="dropdown-menu">
                {{-- <li class=" {{Request::is('admin/main') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin.main.home') }}">Statistic</a></li> --}}
                <li class=" {{Request::is('admin/main/statistic') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin.main.statistic') }}">Statistic</a></li>
                <li class=" {{Request::is('admin/main/participant') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin.main.participant') }}">Participant</a></li>
              </ul>
            </li>
